...
class CityDatabase:
    ...
    def __init__(self, file_path):
        ...
        """
        file_path = 'city_locations_test.xlsx'
...
class ISSDataRequest:
    ...
    @classmethod
    def get_overhead_pass(cls) -> CityOverheadTimes:
        city = City(CityDatabase.city_db.lat, CityDatabase.city_db.lon)
        response = requests.get(ISSDataRequest.OPEN_NOTIFY_OVERHEAD_PASS_URL+f'?lat={city.lat}&lon={city.lon}')
