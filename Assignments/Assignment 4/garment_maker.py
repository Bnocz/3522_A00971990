...
class GarmentMaker:
    ...
    def shirt_women_maker(self, shirt_women_order):
        self.shirts_women.extend([shirt_women_order.factory.create_shirt_men(shirt_women_order)] * shirt_women_order.count)

    def socks_unisex_maker(self, socks_unisex_order):
        self.shirts_men.extend([socks_unisex_order.factory.create_shirt_men(socks_unisex_order)] * socks_unisex_order.count)